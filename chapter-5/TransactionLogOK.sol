...
contract TransactionLogOK {
    ...
    function setTransaction(
        bytes32 user_id, bytes32 project_id, string tran_data) public {
        // (★) すでに登録されている場合は例外にする
    ...
    function getTransaction(bytes32 user_id, bytes32 project_id) public view returns (string tran_data) {
