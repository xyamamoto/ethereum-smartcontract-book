...
contract RandomNumber {
    ...
    // (1) デバッグ用に、blockhashとseed値を返すように変更
    function get(uint _index) public view returns (
        int status, bytes32 blockhash, bytes32 seed, uint drawnNumber){
